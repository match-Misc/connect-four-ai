...
class ConnectFourDetector:
    ...
    DETECTION_THRESHOLD = 100  # Color distance threshold for piece detection (lower: stricter detection, reduces false positives but increases false negatives; higher: more lenient, increases false positives but reduces false negatives; rough range: 50-100)
